  ...
  return (
    <PubThemeProvider>
      <div className="min-h-screen bg-[var(--pub-bg)] text-[var(--pub-text)]">
        ...
        <footer className="border-t bg-[var(--home-surface)]" style={{ borderColor: "rgba(0,0,0,0.04)" }}>
          <div className="mx-auto max-w-6xl px-6 py-16 sm:px-8 sm:py-20 lg:px-12">
            ...
            <div className="mt-12 pt-8 text-sm text-[var(--home-text-subtle)]" style={{ borderTop: "1px solid rgba(0,0,0,0.04)" }}>
              ...
              . Quality contributions, built by the community for the community.
            </div>
          </div>
        </footer>
      </div>
